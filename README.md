...
* Set the `credsStore` option in your docker config (usually `~/.docker/config.json`) file with the suffix of the compiled binary (everything after "docker-credential-").
